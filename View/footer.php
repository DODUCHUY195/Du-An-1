<footer class="pt-20 pb-4" style="background-image: url(view/images/background_pattern.png);">
    <div class="section-shape top-0" style="background-image: url(view/images/shape8.png);"></div>
                ...
                <div class="row attract-slider">
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-3.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-4.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-5.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-1.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-7.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-8.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-2.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-6.jpg" alt="insta"></a>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="insta-image rounded">
                            <a href="gallery.html"><img src="view/images/insta/ins-9.jpg" alt="insta"></a>
                        </div>
                    </div>
                </div>
            </div>
...
<<<<<<< HEAD
                        ...
                        <ul>
                            ...
                            <li class="white"><strong>Email:</strong> <a
                                    ...
                                    class="__cf_email__"
                                    data-cfemail="a8c1c6cec7e8fcdac9decdc4c1c686cbc7c5">[email&#160;protected]</a></li>
...
=======
                        ...
                        <h3 class="info">Tổng Đài Liên Hệ</h3>
                        <h2 class="info">1900 6067</h2>
                        <img class="uytin" src="view/images/bocongthuong.png" alt="">
                        <h6 class="info">CÔNG TY Trách Nghiệm Hữu Hạn 3 Thành Viên</h6>
                        <h6 class="info">Địa chỉ:Cổng số 1, Tòa nhà FPT Polytechnic, 13 phố Trịnh Văn Bô, phường Phương
                            Canh, quận Nam Từ Liêm, TP Hà Nội

                            Km12 Cầu Diễn, Phường Phúc Diễn, Quận Bắc Từ Liêm, Hà Nội </h6>
                        <h6 class="info">Email: 3anhem@gmail.com </h6>
                        <h6 class="info">Điện thoại: 0338550061 </h6>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-4 pe-4">
                    ...
                    <div class="">
                        <h3 class="info">ViVu Travel Lines</h3>
...
=======
                    <p class="textfoot">Bản Quyền Thuộc Sở Hữu Của ViVu Travel</p>
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="blog-image rounded">
                                        <a href="#"
                                            style="background-image: url(view/images/trending/trending5.jpg);"></a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
...
<script src="view/js/particlerun.js"></script>
<script src="view/js/plugin.js"></script>
<script src="view/js/main.js"></script>
<script src="view/js/custom-swiper.js"></script>
<script src="view/js/custom-nav.js"></script>
<<<<<<< HEAD
<script>
(function() {
    var js =
        "window['__CF$cv$params']={r:'825652cf9e7204f0',t:'MTY5OTg3MTI2MC4xMDgwMDA='};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/9914b343/main.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";
