        ...
        <div class="row align-items-center justify-content-between mb-6 ">
            <div class="col-lg-7">
                <div class="section-title text-center text-lg-start">
                    <h2 class="mb-1">Chuyến Đi Phổ Biến</h2>
                </div>
            </div>
            <div class="col-lg-5">
            </div>
...
=======
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item rounded box-shadow">
                        <div class="trend-image position-relative">
                            <img src="view/images/content2.png" alt="image" class>

                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                            <h5 class="theme mb-1"><i class="flaticon-location-pin"></i> Hà Nội - Thanh Hóa</h5>
                            <div class="entry-meta">
                                <div class="entry-author d-flex align-items-center">
                                    <p class="mb-0"><span class="theme fw-bold fs-5"> 200.000đ</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item rounded box-shadow">
                        <div class="trend-image position-relative">
                            <img src="view/images/content3.png" alt="image" class>

                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                            <h5 class="theme mb-1"><i class="flaticon-location-pin"></i> Hà Nội - Bắc Giang</h5>
                            <div class="entry-meta">
                                <div class="entry-author d-flex align-items-center">
                                    <p class="mb-0"><span class="theme fw-bold fs-5"> 100.000đ</span>
                                    </p>
                                </div>
                            </div>
                        </div>
...
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                        <img src="view/images/destination/destination1.jpg" alt="image">
                        <div
...
=======
                                <h5 class="mb-0"><a href="tour-grid.html" class="theme1">Hải Dương</a></h5>
                                <h3 class="mb-0 white">Phú Thọ</h3>
                            </div>
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                        </div>
            ...
            <div class="col-lg-7">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item1">
                            <div class="trend-image position-relative rounded">
                                <img src="view/images/destination/destination17.jpg" alt="image">
                                <div
                                    class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                    <div class="trend-content-title">
<<<<<<< HEAD
...
=======
                                        <h5 class="mb-0"><a href="tour-grid.html" class="theme1">Thái Nguyên</a>
                                        </h5>
                                        <h3 class="mb-0 white">Quảng Ninh</h3>
                                    </div>
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                                </div>
                                <div class="color-overlay"></div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item1">
                            <div class="trend-image position-relative rounded">
                                <img src="view/images/destination/destination14.jpg" alt="image">
                                <div
                                    class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                    <div class="trend-content-title">
<<<<<<< HEAD
...
=======
                                        <h5 class="mb-0"><a href="tour-grid.html" class="theme1">Hà Giang</a>
                                        </h5>
                                        <h3 class="mb-0 white">Cao Bằng</h3>
                                    </div>
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                                </div>
                                <div class="color-overlay"></div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item1">
                            <div class="trend-image position-relative rounded">
                                <img src="view/images/destination/destination15.jpg" alt="image">
                                <div
...
<<<<<<< HEAD
                                    ...
                                    <span class="white bg-theme p-1 px-2 rounded">15 Tours</span>
=======
                                        <h5 class="mb-0"><a href="tour-grid.html" class="theme1">Bắc Kạn</a>
                                        </h5>
                                        <h3 class="mb-0 white">Yên Bái</h3>
                                    </div>
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                                </div>
                                <div class="color-overlay"></div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 mb-4">
                        <div class="trend-item1">
                            <div class="trend-image position-relative rounded">
                                <img src="view/images/destination/destination16.jpg" alt="image">
                                <div
                                    class="trend-content d-flex align-items-center justify-content-between position-absolute bottom-0 p-4 w-100 z-index">
                                    <div class="trend-content-title">
<<<<<<< HEAD
...
=======
                                        <h5 class="mb-0"><a href="tour-grid.html" class="theme1">Lai Châu</a>
                                        </h5>
                                        <h3 class="mb-0 white">Thái Bình</h3>
                                    </div>
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                                </div>
                                <div class="color-overlay"></div>
...
<<<<<<< HEAD
<section class="about-us pt-0" style="background-image:url(view/images/bg/bg-trans.png);">
    <div class="container">
        <div class="about-image-box">
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-lg-6 mb-4 pe-4">
                    <div class="about-image overflow-hidden">
                        <img src="view/images/travel1.png" alt>
                    </div>
                </div>
        ...
        <div class="trend-box">
            <div class="row item-slider">
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item rounded box-shadow">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trending2.jpg" alt="image" class>
                            <div class="color-overlay"></div>
                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item box-shadow rounded">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trending3.jpg" alt="image">
                            <div class="color-overlay"></div>
                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                            <div class="trend-meta bg-theme white px-3 py-2 rounded">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item box-shadow rounded">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trending4.jpg" alt="image">
                            <div class="color-overlay"></div>
                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                            <div class="trend-meta bg-theme white px-3 py-2 rounded">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 mb-4">
                    <div class="trend-item box-shadow rounded">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trending1.jpg" alt="image">
                            <div class="color-overlay"></div>
                        </div>
                        <div class="trend-content p-4 pt-5 position-relative">
                            <div class="trend-meta bg-theme white px-3 py-2 rounded">
...
<section class="trending pb-0 pt-6" style="background-image: url(view/images/shape2.png);">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 mb-4">
                    <div class="trend-item1 rounded box-shadow mb-4">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trendingb-2.jpg" alt="image" class>
                    ...
                    <div class="trend-item1 rounded box-shadow mb-4">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trending-large.jpg" alt="image" class>
                            <div class="trend-content1 p-4">
                    ...
                    <div class="trend-item1 rounded box-shadow">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trendingb-1.jpg" alt="image" class>
                            <div class="trend-content1 p-4">
                ...
                <div class="col-lg-7">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                <div class="trend-image position-relative">
                                    <img src="view/images/trending/trending1.jpg" alt="image" class>
                                    <div class="color-overlay"></div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                <div class="trend-image position-relative">
                                    <img src="view/images/trending/trending3.jpg" alt="image" class>
                                    <div class="color-overlay"></div>
                                </div>
                                <div class="trend-content p-4 pt-5 position-relative bg-white">
                                    <div class="trend-meta bg-theme white px-3 py-2 rounded">
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="trend-item rounded box-shadow">
                                <div class="trend-image position-relative">
                                    <img src="view/images/trending/trending4.jpg" alt="image" class>
                                    <div class="color-overlay"></div>
                                </div>
                                <div class="trend-content p-4 pt-5 position-relative bg-white">
                                    <div class="trend-meta bg-theme white px-3 py-2 rounded">
...
<section class="discount-action pt-6"
    style="background-image:url(view/images/section-bg1.png); background-position:center;">
                ...
                <div class="trend-content-main">
                    ...
                    <div class="video-button text-center position-relative">
                        <div class="call-button text-center">
                            <button type="button" class="play-btn js-video-button" data-video-id="870769596"
                                data-channel="vimeo">
...
=======
            <h2 class="mb-1">Một Số <span class="theme">Lưu Ý </span> Khi Đặt Vé</h2>
        </div>
...
>>>>>>> 94c5379d1a882fbcee51c4c700513556399080ea
                ...
                <div class="col-lg-4 mb-4">
                    <div class="trend-item box-shadow rounded bg-white">
                        <div class="trend-image position-relative">
                            <img src="view/images/trending/trending2.jpg" alt="image">
<<<<<<< HEAD
        ...
        <div class="team-main">
            <div class="row shop-slider">
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="team-list rounded">
                        <div class="team-image">
                            <img src="view/images/team/img1.jpg" alt="team">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="team-list rounded">
                        <div class="team-image">
                            <img src="view/images/team/img2.jpg" alt="team">
                        </div>
                        <div class="team-content text-center p-3 bg-theme">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="team-list rounded">
                        <div class="team-image">
                            <img src="view/images/team/img4.jpg" alt="team">
                        </div>
                        <div class="team-content text-center p-3 bg-theme">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 mb-4">
                    <div class="team-list rounded">
                        <div class="team-image">
                            <img src="view/images/team/img3.jpg" alt="team">
                        </div>
                        <div class="team-content text-center p-3 bg-theme">
...
<section class="testimonial pt-9" style="background-image:url(view/images/testimonial.png)">
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-lg-5 pe-4">
                <div class="testimonial-image">
                    <img src="view/images/travel2.png" alt>
                </div>
            </div>
                    ...
                    <div class="col-sm-4 item">
                        <div class="testimonial-item1 rounded">
                            <div class="author-info d-flex align-items-center mb-4">
                                <img src="view/images/testimonial/img1.jpg" alt>
...
<div class="our-partner p-0">
    <div class="container">
        <div class="partners_inner">
            <ul>
                <li><img src="view/images/cl-5.png" alt></li>
                <li><img src="view/images/cl-2.png" alt></li>
                <li><img src="view/images/cl-3.png" alt></li>
                <li><img src="view/images/cl-4.png" alt></li>
                <li><img src="view/images/cl-5.png" alt></li>
                <li><img src="view/images/cl-3.png" alt></li>
                <li><img src="view/images/cl-2.png" alt></li>
                <li><img src="view/images/cl-1.png" alt></li>
            </ul>
        </div>
    </div>
</div>
        ...
        <div class="recent-articles-inner">
            <div class="row">
                <div class="col-lg-4">
                    <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                        <div class="trend-image">
                            <img src="view/images/trending/trending10.jpg" alt="image">
                        </div>
                            ...
                            <div class="trend-content">
                                ...
                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author mb-2">
                                        <img src="view/images/reviewer/2.jpg" alt class="rounded-circle me-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                        <div class="trend-image">
                            <img src="view/images/trending/trending12.jpg" alt="image">
                        </div>
                        <div class="trend-content-main p-4 pb-2">
                            <div class="trend-content">
                                ...
                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author mb-2">
                                        <img src="view/images/reviewer/1.jpg" alt class="rounded-circle me-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="trend-item box-shadow bg-white mb-4 rounded overflow-hidden">
                        <div class="trend-image">
                            <img src="view/images/trending/trending13.jpg" alt="image">
                        </div>
                        <div class="trend-content-main p-4 pb-2">
                            <div class="trend-content">
                                ...
                                <div class="entry-meta d-flex align-items-center justify-content-between">
                                    <div class="entry-author mb-2">
                                        <img src="view/images/reviewer/3.jpg" alt class="rounded-circle me-1">
